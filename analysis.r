...
pilot_pps = c("lk", "pp3", "222", "1") # some of these still have different data structures
...
#     x$params$cue_onset)) + prime_start + cycles_prime,
...
trial_durs <- trial_durs_df %>%
  mutate(
    condition = case_when(
      cue_present & cue_delay == 10 ~ "Cue delay 10",
